...
{
    "distutils": {
        "name": "crawler321.main",
        "sources": [
            "crawler321\\main.py"
        ]
    },
    "module_name": "crawler321.main"
}
END: Cython Metadata */
...
#define __PYX_HAVE__crawler321__main
#define __PYX_HAVE_API__crawler321__main
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "crawler321.main" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "crawler321.main"
extern int __pyx_module_is_main_crawler321__main;
int __pyx_module_is_main_crawler321__main = 0;

/* Implementation of "crawler321.main" */
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_crawler321__main) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "crawler321.main")) {
      if (unlikely((PyDict_SetItemString(modules, "crawler321.main", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init crawler321.main", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init crawler321.main");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
